...
| vmPFC — Ventromedial | 88 | 22 | 110 | specializes in emotional regulation, social cognition, and risk evaluation |
| **Total** | **508** | **124** | **632** | |
...
shrank from 790 records to 632. The reduction is concentrated in mPFC (191 → 133) and OFC
(199 → 128), where much of the original content was near-duplicate phrasing or belonged to the
other region. Validation sets run 22–29 records each — correct as a ratio, but thin in absolute
...
**Scale.** 632 records is small for instruction tuning. Suited to adapter-based fine-tuning or as a
